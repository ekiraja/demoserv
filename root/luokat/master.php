...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>Taitotalo</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="../img/tt-logo-white.svg" height="auto"></span>
    </a>
    <!-- Header Navbar -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-medkit"></i> <span>Varaukset</span>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-medkit"></i> <span>Kouluttajat</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/luokat/opettaja/uusi.php">Lisää kouluttaja</a></li>
            <li><a href="/luokat/opettaja">Kaikki koluttajat</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#"><i class="fa fa-medkit"></i> <span>Tilat</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-medkit"></i> <span>Kurssit</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Työpöytä
        <small>Tervetuloa varaus työpöytään</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Opetustilat</a></li>
        <li class="active">Työpöytä</li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong>This is for demo use only. Created by Eki Rajamäki 2020.
  </footer>
